      ...
      <div className="flex-1 flex flex-col items-center gap-16 min-h-0">
        <header className="flex flex-col items-center gap-9">
          <div className="w-[500px] max-w-[100vw] p-4">
            <p
              className='text-center'>Hi, I&apos;m <span className="text-pink-600 border pr-1 pl-1 border-pink-600 rounded-4xl animate-bounce ...">Saba</span>. Welcome to my portfolio!</p>
            <img
              src={personalPhoto}
              alt="photo of me"
